...
<input autocomplete="off" type="text" class="form-control dt_picker" id="check_in" name="check_in" value="{{ old('check_in') ? date('Y-m-d',strtotime(old('check_in'))) : '' }}">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <div class="input-group">
<input autocomplete="off" type="text" class="form-control dt_picker" id="check_out" name="check_out" value="{{ old('check_out') ? date('Y-m-d',strtotime(old('check_out'))) : '' }}">
                    <span class="input-group-addon"></span>
                </div>
                <i class='bx bxs-calendar'></i>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="room-card-two">
                            <div class="row align-items-center">
                                ...
                                <ul>
                                    <li><i class='bx bx-show-alt'></i> {{ $item->size }}</li>
