...
@endphp
                    ...
                    <div class="comments-wrap">
                        ...
                        @foreach ($comment as $com)    
                            <li>
                                <img src="{{ (!empty($com->user->photo)) ? url('upload/user_images/'.$com->user->photo) : url('upload/no_image.jpg') }}" alt="Image" width="50" height="50">
                                <h3>{{ $com->user->name }}</h3>
...
<p>Plz <a href="{{ route('login') }}">Login</a> First to Add Comment</p>
