...
<form class="row g-3" id="myForm" action="{{ route('store.blog.post') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-md-12">
        ...
        <textarea class="form-control" id="input11" name="short_descp" rows="3"></textarea>
    </div>

    <div class="col-md-12">
        <label for="input11" class="form-label">Long Description</label>
        <textarea class="form-control" name="long_descp" id="myeditorinstance" rows="3"></textarea>
    </div>
