...
<img style="height:100px; width:120px;object-fit: cover" src="{{ asset(!empty($room->image))? url('upload/roomimg/'.$room->image):url('upload/no_image.jpg') }}" alt="Images" alt="Images">
