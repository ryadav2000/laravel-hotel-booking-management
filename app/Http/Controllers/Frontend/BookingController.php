...
class BookingController extends Controller
{
    ...
    public function UpdateBooking(Request $request, $id){
     ...
     public function AssignRoom($booking_id){
        ...
        $check_date_booking_ids = RoomBookDate::whereIn('book_date',$booking_date_array)->where('room_id',$booking->rooms_id)->distinct()->pluck('booking_id')->toArray();
