...
<div class="page-content">
    ...
    <div class="col-md-6">
        ...
        <select name="group_name" id="" class="form-select mb-3" aria-label="Default select example">
            ...
            <option value="Manage Comment" {{ $permission->group_name == 'Blog' ? 'selected' : '' }}>Manage Comment</option>
