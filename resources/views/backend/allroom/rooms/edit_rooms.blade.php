...
<form class="row g-3" action="{{ route('update.room',$editData->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="input1" name="roomtype_id"  value="{{ $editData['type']['name'] }}">
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="input2" name="total_child" value="{{ $editData->total_child }}">
    </div>
    ...
    <div class="col-md-6">
        ...
        <img id="showImage" src="{{ (!empty($editData->image)) ? url('upload/roomimg/'.$editData->image) : url('upload/no_image.jpg') }}" alt="Admin" class="bg-primary" width="80" height="50px">
    </div>

    <div class="col-md-6">
        <label for="input4" class="form-label">Gallery Image</label>
        <input type="file" class="form-control" multiple id="multiImg" name="multi_img[]" accept="image/jpeg, image/jpg, image/gif, image/png">
        ...
        <a href="{{ route('multi.image.delete',$item->id) }}" class="lni lni-close"></a>
        @endforeach
    ...
    <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="input1" name="size"  value="{{ $editData->size }}">
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="input2" name="room_capacity" value="{{ $editData->room_capacity }}">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-12">
        ...
        <textarea class="form-control" name="description" id="myeditorinstance" rows="3">{!! $editData->description !!}</textarea>
    </div>
         ...
         <div class="container mt-2">
            <div class="row">
               <div class="form-group col-md-6">
                  <label for="erve
                  facility_name">Room Facilities</label>
                  <select name="facility_name[]" id="basic_facility_name" class="form-control">
                        <option value="">Select Facility</option>
 <option value="Complimentary Breakfast">Complimentary Breakfast</option>
 <option value="32/42 inch LED TV" > 32/42 inch LED TV</option>
