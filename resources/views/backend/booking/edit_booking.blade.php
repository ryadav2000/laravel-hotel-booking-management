                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h6 class="my-1 text-danger">{{ $editData->created_at->format('d/m/Y') }}</h6>
                        </div>
          ...
          <div class="card-body">
              <div class="table-responsive">
                ...
                <style>
                    ...
                    <table class="table test_tabel" style="float: right" border="none">
                        <tr>
                            <td>Subtotal</td>
                ...
                <!-- Dynamic data from total room available in the hotel-->
                    ...
                    <form action="{{ route('update.booking',$editData->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="date" required value="{{ $editData->check_in }}" name="check_in" class="form-control" id="check_in">
                            </div>
                            <div class="col-md-12 mb-2">
                                <label for="">Check Out</label>
                                <input type="date" required value="{{ $editData->check_out }}" name="check_out" class="form-control" id="check_out">
                            </div>
                            <div class="col-md-12 mb-2">
                                <label for="">No. of Room</label>
                                <input type="number" required value="{{ $editData->number_of_rooms }}" name="number_of_rooms" class="form-control" id="">
                            </div>
